 ...
 */
public class ItemUnsmeltedIngot extends Item {

    /*
     * Granddad always told me "keep your data separate from your code."
     * Sorry granddad, I'm lazy. That's not an excuse, it's just an explanation of what happened.
     */
    ...
    public ItemUnsmeltedIngot() {
        setUnlocalizedName(Reference.MODID + "_unsmelted_ingot");
        setRegistryName("unsmelted_ingot");
        setHasSubtypes(true);
